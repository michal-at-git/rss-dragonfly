...
class AboutDialog(QDialog):
  def __init__(self, parent=None):
    ...
    header = """<img src="GUI/ikonka.png" alt="" style="float: left" /> <p style="float: left; margin: 4px"><b>RSS Dragonfly wersja 1.1</b></p> 
    ...
    <p>Strona projektu: <a href="http://rss-dragonfly.michalt.pl/">http://rss-dragonfly.michalt.pl/</a></p>""";
